...
training_history.to_csv('./calc/regression/cnn/training_history_incrneuron_dropout.csv', index=False)
...
predictions.to_csv('./calc/regression/cnn/predictions_incrneuron_dropout.csv', index=False)
