...
ggsave('./fig/regression/cnn/multimodel_roc_gradability_cutoff_2.png', height=8, width=8)
...
ggsave('./fig/regression/cnn/minimal_roc_gradability_cutoff_2.png', height=8, width=8)
